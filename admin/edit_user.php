...
$result=mysqli_query($con,"select id, email, password from signup where id='$user_id'")or die ("query 1 incorrect.......");
...
mysqli_query($con,"update signup set email='$user_name', password='" . md5($password) . "' where id='$user_id'")or die("Query 2 is inncorrect..........");
