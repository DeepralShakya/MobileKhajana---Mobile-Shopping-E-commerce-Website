...
function getPro(){
	...
	$get_pro = "select * from products order by 1 DESC LIMIT 0,12";
	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo "
			...
			<div class='panel panel-success'>
			 <div class='panel panel-heading'><h4 class='text-center'>$pro_title</h4></div>
              <div class='panel panel-body'>  
			  <img src='admin_area/product_images/$pro_image' height='120px' width='150px'/>
			  <div class='product'>
			  <b> Price: $ $pro_price </b><br/>
			  <a href='details.php?pro_id=$pro_id'>Details</a>
						
					
					<a href='index.php?add_cart=$pro_id'><button  class='btn btn-danger' >Add To Cart</button></a>
